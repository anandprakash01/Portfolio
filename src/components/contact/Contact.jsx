        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">ap.anandprakash21@gmail.com</span>

              <a href="mailto:ap.anandprakash21@gmail.com" className="contact_button">
        ...
        <div className="contact_content">
          ...
          <form ref={form} onSubmit={sendEmail} className="contact_form">
            ...
            <div className="contact_form-div contact_form-area">
              <label htmlFor="write-your-project" className="contact_form-tag">
                Project
              </label>
              <textarea
                name="project"
                id="write-your-project"
                cols="30"
                rows="10"
                className="contact_form-input"
